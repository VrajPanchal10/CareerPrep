...
const GitHubConnectPanel = ({ onConnect, loading, error }) => {
    return (
        <div className="gh-connect-panel" role="region" aria-label="GitHub Connection">
            ...
            <h3 className="gh-connect-panel__title" style={{ marginBottom: "0.5rem" }}>Connect GitHub Account</h3>
            <ul className="gh-connect-panel__perms" aria-label="Permissions requested">
                <li>
                    <Check className="perm-icon" size={16} aria-hidden="true" style={{ color: "#3b82f6" }} />
                    <span>Read public profile</span>
                </li>
                <li>
                    <Check className="perm-icon" size={16} aria-hidden="true" style={{ color: "#3b82f6" }} />
                    <span>Read repositories</span>
                </li>
                <li>
                    <Check className="perm-icon" size={16} aria-hidden="true" style={{ color: "#3b82f6" }} />
